...
public class PinValidatorTests {
    @Test
    @DisplayName("Should return true when given a string of length 4 or 6 containing com.sexton.challenges.codewars.digits 0-9")
    ...
    @Test
    @DisplayName("Should return false when given characters that are not com.sexton.challenges.codewars.digits")
